...
(library (arew untangle)
  ...
  ;; thread. This is done like so to be DRY, and hopefully fast.
  ...
  (define (untangle-exec-network-continuations untangle)
    ...
    ;; the sleep precision is nanoseconds, meanwhile epoll is
    ;; milliseconds.
  ...
  (define (untangle-sleep nanoseconds seconds)
    ...
    ;; TODO: The following is not implemented in the case of POSIX threads.
